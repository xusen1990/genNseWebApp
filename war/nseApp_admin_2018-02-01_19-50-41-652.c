...
int main(int argc, const char* argv[])
{
	...
	strcpy(bitmask, "");
	str2binary(bitmask, 320);
	...
	MyKguSegment->offset = 48;
	MyKguSegment->byteCount = 15;
	nseStatus = NseProfile_KguSegment_Add(MyProfile, 0, MyKguSegment, 3);
	if (nseStatus != Nse_OK)
	{
		printf("Error: fail to add kgu segment\n");
		goto done;
	}
	MyKguSegment->offset = 64;
	MyKguSegment->byteCount = 15;
	nseStatus = NseProfile_KguSegment_Add(MyProfile, 0, MyKguSegment, 4);
	if (nseStatus != Nse_OK)
	{
		printf("Error: fail to add kgu segment\n");
		goto done;
	...
	file = "nseApp_admin_2018-02-01_19-50-41-652_rule.txt";
	filetofile(file);

	num = 0;
	//------------------------Add ACL Record ----------------------------------------------------------

	fp = fopen("nseApp_admin_2018-02-01_19-50-41-652_T1.txt", "r");
...
//------------------------Add Ad----------------------------------------------------------
	...
	fclose(fp);
	fp = fopen("nseApp_admin_2018-02-01_19-50-41-652_T2.txt", "r");
	...
	while(fgets(data_buff, 3000, fp) != NULL)
	{
		...
		printf("             mask: %s\n", mask);
//------------------------Add Ad----------------------------------------------------------
	MyAD = NseManagerDp_AdBlock_Get(MyStargate, 0, 1);  // get ad handler
	memset(data, 0, sizeof(data));
	int2Bin(num, data, 16);
	for (int i = 16; i < 64; i++)
	{
	...
	printf("Add AD entry: %s\n", data);
	str2binary(data, 64);  // convert data string to binary memory
	nseStatus = NseAdBlock_AD_Add(MyAD, prio, data);  // add AD entry to address 100, pair with the record just added
		if (nseStatus != Nse_OK)
		{
			printf("Error: fail to add ad entry\n\n");
	...
	fclose(fp);
	fp = fopen("nseApp_admin_2018-02-01_19-50-41-652_T3.txt", "r");
	...
	while(fgets(data_buff, 3000, fp) != NULL)
	{
		...
		memset(mask, 0, sizeof(mask));
		MyRecord = NseTable_Record_Get(MyTable, prio);  // read record from database
		binary2str(MyRecord->data, data, 80);  // convert binary memory to data string
		binary2str(MyRecord->mask, mask, 80);  // convert binary memory to data string
		printf("Read record: data: %s\n", data);
		printf("             mask: %s\n", mask);
		num++;
	}
	fclose(fp);
	fp = fopen("nseApp_admin_2018-02-01_19-50-41-652_T4.txt", "r");
	...
	fp = fopen("nseApp_admin_2018-02-01_19-50-41-652_T5.txt", "r");
	...
	fclose(fp);
	fp = fopen("nseApp_admin_2018-02-01_19-50-41-652_T6.txt", "r");
	...
	fclose(fp);
	fp = fopen("nseApp_admin_2018-02-01_19-50-41-652_T7.txt", "r");
	...
	fclose(fp);
	fp = fopen("nseApp_admin_2018-02-01_19-50-41-652_T8.txt", "r");
	...
	fclose(fp);
	file = "nseApp_admin_2018-02-01_19-50-41-652_searchkey.txt";
	filetofile(file);

	//------------------------Add profile1 Search ----------------------------------------------------------

	fp = fopen("nseApp_admin_2018-02-01_19-50-41-652_profile1searchkey.txt", "r");
	...
	while(fgets(data_buff, 3000, fp) != NULL)
	{
		...
		nseStatus = NseManagerDp_Lookup(MyStargate, 0, 0, 0, 7, search, 80, MyResponse);  // send search request to TCAM, the response will be ready(searched), match(hit), priority
		if (nseStatus != Nse_OK)
		{
	...
	fp = fopen("nseApp_admin_2018-02-01_19-50-41-652_profile2searchkey.txt", "r");
	nseStatus = NseLookupResponse_Create(&MyResponse);
	if (nseStatus != Nse_OK)
	{
		printf("Error: fail to create response buffer\n");
	...
	fp = fopen("nseApp_admin_2018-02-01_19-50-41-652_profile3searchkey.txt", "r");
	nseStatus = NseLookupResponse_Create(&MyResponse);
	if (nseStatus != Nse_OK)
	{
		printf("Error: fail to create response buffer\n");
	...
	while(fgets(data_buff, 3000, fp) != NULL)
	{
		...
		nseStatus = NseManagerDp_Lookup(MyStargate, 0, 2, 0, 5, search, 60, MyResponse);  // send search request to TCAM, the response will be ready(searched), match(hit), priority
		if (nseStatus != Nse_OK)
		{
			printf("Error: fail to perform search\n");
			goto done;
	...
	fp = fopen("nseApp_admin_2018-02-01_19-50-41-652_profile4searchkey.txt", "r");
	nseStatus = NseLookupResponse_Create(&MyResponse);
	if (nseStatus != Nse_OK)
	{
		printf("Error: fail to create response buffer\n");
	...
	fp = fopen("nseApp_admin_2018-02-01_19-50-41-652_profile5searchkey.txt", "r");
	nseStatus = NseLookupResponse_Create(&MyResponse);
	if (nseStatus != Nse_OK)
	{
		printf("Error: fail to create response buffer\n");
	...
	while(fgets(data_buff, 3000, fp) != NULL)
	{
		...
		nseStatus = NseManagerDp_Lookup(MyStargate, 0, 4, 0, 3, search, 40, MyResponse);  // send search request to TCAM, the response will be ready(searched), match(hit), priority
		if (nseStatus != Nse_OK)
		{
			printf("Error: fail to perform search\n");
			goto done;
	...
	fp = fopen("nseApp_admin_2018-02-01_19-50-41-652_profile6searchkey.txt", "r");
	nseStatus = NseLookupResponse_Create(&MyResponse);
	if (nseStatus != Nse_OK)
	{
		printf("Error: fail to create response buffer\n");
